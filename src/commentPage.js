...
import api from './reviews/stubAPI';
...
var CommentView = React.createClass({ 
    ...
    addComment : function(c,n) {
      ...
      api.addComment(pid,c,f,s,a);
      this.setState({});
  }, // update addComment api to match function identifiers/codes in stubAPI
